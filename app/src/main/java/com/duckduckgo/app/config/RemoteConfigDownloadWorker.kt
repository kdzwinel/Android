...
class RemoteConfigDownloadWorker(context: Context, workerParameters: WorkerParameters) : CoroutineWorker(context, workerParameters) {
    lateinit var feature: Feature

    override suspend fun doWork(): Result {
        return withContext(Dispatchers.IO) {
            feature.downloadConfigs()
...
class RemoteConfigDownloadWorkerScheduler @Inject constructor(
    ...
    fun scheduleRemoteConfigDownload() {
        ...
        val workerRequest = PeriodicWorkRequestBuilder<RemoteConfigDownloadWorker>(12, TimeUnit.HOURS)
